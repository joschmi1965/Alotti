...
- type Pgn, Fen
- move deepness
- origin eg. web link if provided

On the answer card a date/timestamp is set.
...
- By the use of a sequence indicator '>' all moves till next multiplier (or EOL) are taken as the answer.
...
but keep the rest of learning data for the future learning period. An alternative is to build "Stapel" in AnkiBot with the help of filering eg. by deepness or other tags.
